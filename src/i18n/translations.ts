...
export const translations = {
  en: {
    ...
    home: {
      ...
      noAdvice: 'No personalized advice available yet. This section will be populated by the AI nutrition engine in a future update.',
  ...
  zh: {
    ...
    home: {
      ...
      noAdvice: '暂无个性化建议。此部分将在未来由 AI 营养引擎填充。',
  ...
  es: {
    ...
    home: {
      ...
      noAdvice: 'Aún no hay consejos personalizados. Esta sección será completada por el motor de nutrición de IA en una actualización futura.',
